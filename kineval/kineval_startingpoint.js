...
kineval.startingPlaceholderInit = function startingPlaceholderInit() {
    ...
    */
    ...
    spacingGlobal = 0.9;  // variables declared without "var" are global
...
kineval.startingPlaceholderUserInput = function startingPlaceholderUserInput() {
    ...
    */
    ...
    // STENCIL: update the global spacing variable
        ...
        textbar.innerHTML = "Welcome to KinEval. Fuck around and find out";//"Welcome to KinEval. I want to see some text. Can you place a message here?"; 
    }
}
